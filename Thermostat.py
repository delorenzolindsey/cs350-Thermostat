...
class TemperatureMachine(StateMachine):
    ...
    ##
    def processTempStateButton(self, *args):
        if(DEBUG):
    ...
    ##
    def processTempIncButton(self, *args):
        if(DEBUG):
            print("Increasing Set Point")

        ##
        ## TODO: COMPLETE 
        ##update the setPoint of the thermostat and the status lights within the circuit.
        self.setPoint += 1
        self.updateLights()
    ...
    ##
    def processTempDecButton(self, *args):
        if(DEBUG):
    ...
    def updateLights(self):
        ...
        ##
        ## TODO: COMPLETE
        ## update the status lights in our thermostat circuit. 
    ...
    def setupSerialOutput(self):
        ...
        ## that will provide the single  line of text that will
        ## be sent to the TemperatureServer over the Serial Port (UART). 
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                ## degrees Fahrenheit. 
                lcd_line_2 = f"Temp: {floor(self.getFahrenheit())} SP: {self.setPoint} F"
...
##
## TODO: COMPLETE
## assign a function to be triggered when the button is pushed to 
